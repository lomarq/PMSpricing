 ...
 */
export const setFullDataState = async (data) => {
...
export const updateSingleProduct = async (productToUpdate) => {
...
export const saveAllProducts = async (newProducts) => {
  await new Promise(resolve => setTimeout(resolve, 250));
  const data = getFullDataState();
...
export const saveLogo = async (logoBase64) => {
    await new Promise(resolve => setTimeout(resolve, 250));
    const data = getFullDataState();
